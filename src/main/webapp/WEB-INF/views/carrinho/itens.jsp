        ...
        <header id="layout-header">
            <div class="clearfix container">
                ...
                <div id="header-content">
                    <nav id="main-nav">
                        <ul class="clearfix">
                            <li><a href="${ s:mvcUrl('carrinhoItens').build() }" rel="nofollow">Seu carrinho (${carrinhoCompras.quantidade})</a></li>
        ...
        <section class="container middle">
            ...
            <table id="cart-table">
                    ...
                    <c:forEach items="${carrinhoCompras.itens}" var="item">
                        <tr>
                            ...
                            <td class="remove-item">
                                <form action="${s:mvcUrl('removerItemCarrinho').arg(0,item.produto.id).arg(1,item.tipoPreco).build()}" method="POST">
                ...
                <tfoot>
                    <tr>
                        <td colspan="3">
                            <form action="${s:mvcUrl('finalizarCarrinho').build()}" method="post">
