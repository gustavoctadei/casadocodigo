        ...
        <section class="container middle">
            ...
            <table id="cart-table">
                    ...
                    <c:forEach items="${carrinhoCompras.itens}" var="item">
                        <tr>
                            ...
                            <td class="remove-item">
                                <form:form action="${ s:mvcUrl('removerItemCarrinho').arg(0,item.produto.id).arg(1,item.tipoPreco).build() }" method="POST">
                ...
                <tfoot>
                    <tr>
                        <td colspan="4">
                            <form:form action="${s:mvcUrl('finalizarCarrinho').build()}" method="post">
